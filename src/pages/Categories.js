import { Button, Dialog, DialogActions, DialogContent, Grid, GridList, makeStyles, TextField, Typography } from '@material-ui/core';
...
import { create_parent, get_my_parents, get_parents_by_permission } from '../API/parents';
        ...
        <main className={classes.main}>
            ...
            <Dialog open={permissionDialogOpen} onClose={() => {setPermissionDialogOpen(false)}}>
                ...
                <Grid item>
                    ...
                    fullWidth
                    onChange={(e) => {setPermissionInput(e.currentTarget.value)}}
                    onKeyPress={async (ev) => {
                        if (ev.key === 'Enter') {
                          ev.preventDefault();
                ...
                <DialogActions>
                    <Button onClick={() => {setPermissionDialogOpen(false)}} color="primary">
                        Cancel
                    </Button>
