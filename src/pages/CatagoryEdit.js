...
export default function CatagoryEdit(props) {
    ...
    const [parentContent, setParentContent] = React.useState([
        { children: [{ text: "" }] },
    ]);
    ...
    return !isAuthenticated() ? (
        ...
        <main className={classes.main}>
            <div className={classes.sameLine}>
                ...
                <div className={classes.buttonRow}>
                    <Button
                        ...
                        color="secondary"
                        variant="contained"
                        aria-label="Delete This catagory"
                        startIcon={<EditIcon />}
                    ...
                    >
                        ...
                        >
                            <MarkButton
                                format="bold"
                                icon={<FormatBoldIcon />}
                                nonActiveClass={classes.nonActive}
                                activeClass={classes.activeButton}
                            />
                            <MarkButton
                                format="italic"
            ...
            >
                ...
                <DialogActions>
                    <Button
                        onClick={() => setChangeTitleOpen(false)}
                        color="primary"
                    >
                        Cancel
                    </Button>
            ...
            <Dialog
                ...
                onClose={() => setDeleteParentOpen(false)}
            >
                <DialogContent>
                    <Typography>
                        You can't get this back are you sure you want to delete
                        this catagory
                    </Typography>
                </DialogContent>
                <DialogActions>
                    <Button
                        onClick={() => setDeleteParentOpen(false)}
                        color="primary"
                    >
                        Cancel
                    </Button>
