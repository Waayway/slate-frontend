        ...
        <main className={classes.main}>
                    ...
                    <div className={classes.buttonRow}>
                        <Grid>
                            <Button
                                ...
                                variant="contained"
                                aria-label="Give Permission to User"
                                startIcon={<ShareIcon />}
                            >
                            ...
                            <Button
                                ...
                                to={"/edit/catagory/" + parentid}
                                variant="contained"
                                aria-label="Edit This Catagory"
                                startIcon={<EditIcon />}
                            >
                                Edit This Catagory
                            </Button>
                ...
                {!editable && (
                    <div className={classes.buttonRow}>
                        <Button
                            ...
                            className={classes.button}
                            variant="contained"
                            aria-label="Remove Permission from note"
                            startIcon={<DeleteIcon />}
                        >
                            Remove Permission from note
                        </Button>
                    </div>
                )}
            </div>
            {parent && (
                <Box padding={2}>
                    ...
                    <Slate editor={editor} value={JSON.parse(parent.content)}>
                        <Editable
                            readOnly
            ...
            >
                <DialogContent>
                    <Typography>
                        To share this Catagories and the notes beneath it, you
                        can tell them to go to this link:
                    </Typography>
                    {parent && (
                        <>
                            <Link
                                href={`http://${document.location.host}/note/getpermission/${parent.permission}`}
                                color="secondary"
                            >{`${document.location.hostname}/note/getpermission/${parent.permission}`}</Link>
                            <Typography>
                                The key in this case is: " {parent.permission} "
                                You can give either to a friend or whoever needs
                                access to it. But be careful everyone who has
                                this key can read ur notes
                            </Typography>
                        </>
                    )}
                </DialogContent>
